...
struct CrossfadePoolTests {
    ...
    func testSeededReproducibleAndSeedSensitive() {
        ...
        #expect(r1 == r2, "same seed must reproduce the same output")
        ...
        #expect(r1 != r3, "a different seed should draw a different grain sequence")
    }
    ...
    func testDrawsFromMultiplePoolGrains() {
        ...
        #expect(seen.count > 1, "pool draw should source grains from multiple pool entries")
    }
    ...
    func testEqualPowerSeamsNoLoudnessDip() {
        ...
        for value in body { #expect(value >= 1 - 1e-4) }
    }
    ...
    func testShortGrainsLeaveNoSilentGaps() {
        ...
        #expect(longestZeroRun < 100, "short pooled grains must not leave periodic silence: \(longestZeroRun)")
    }
